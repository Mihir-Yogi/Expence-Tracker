...
const checkBudgetExists = () => {
    ...
    if(budget){
        ...
        document.getElementById("editBudgetBtn").addEventListener("click", e => {
            budgetContainer.innerHTML = ""
            budgetContainer.innerHTML = `<input type="number" class="budgetPrice" id="budgetPrice" placeholder="Enter Your Budget" value=${budget}> <button id="budgetBtn"><i class="fa-solid fa-plus"></i>Add</button>`
        ...
        budgetContainer.innerHTML = `<input type="number" class="budgetPrice" id="budgetPrice" placeholder="Add Budget" /> <button id="budgetBtn"><i class="fa-solid fa-plus"></i> Add</button>`
        getPriceDetails(budget)
